...
export default function LeftSidebar() {
    ...
    return (
        <div className="bg-background-50 w-48 flex flex-col pl-2 py-2">
            <NavLink slug={"statistics"}>
                <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M16 20v-7h4v7zm-6 0V4h4v16zm-6 0V9h4v11z"/></svg>
            </NavLink>
            <NavLink slug={""}>
                <svg
                    fill="currentColor"
